...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_BULLET_BILL, 3700, 400, 1800, 0, -90, 0, (2 << 24), bhvBulletBill),
		OBJECT(MODEL_BULLET_BILL, 3700, 400, 2300, 0, -90, 0, (70 << 24), bhvBulletBill),
		MARIO_POS(0x01, 0, 0, 580, 0),
		OBJECT(MODEL_NONE, 0, 580, 0, 0, 0, 0, (0x0A << 16), bhvSpinAirborneWarp),
