...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		WARP_NODE(0xD1, LEVEL_WF, 0x02, 0xD3, WARP_NO_CHECKPOINT),
		WARP_NODE(0xD2, LEVEL_WF, 0x02, 0xD4, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_WF_GIANT_POLE, -4778, 849, -1953, 0, 0, 0, 0x00000000, bhvGiantPole),
		...
		OBJECT(MODEL_PROPELLOR, -2972, -2350, 1038, 0, 0, 0, (10 << 24), bhvPropellor),
		OBJECT(MODEL_PROPELLOR, -2972, -2650, 1038, 0, 0, 0, (8 << 24), bhvPropellor),
		...
		OBJECT(MODEL_NONE, 1321, 1700, -3941, 0, 63, 0, (147 << 16), bhvSignOnWall),
		...
		OBJECT_WITH_ACTS(MODEL_NONE, -2332, 1500, 2097, 0, -180, 0, (0x0d << 16), bhvFadingWarp, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
		OBJECT(MODEL_WF_ROTATING_WOODEN_PLATFORM, -1458, 2600, 400, 0, 0, 0, 0x00000000, bhvWfRotatingWoodenPlatform),
